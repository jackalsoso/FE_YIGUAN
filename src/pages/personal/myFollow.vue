  ...
  <div class="content">
    ...
    <div class="top_right">
      <div class="right_main">
        <van-search  shape="round"  v-model="searchvalue" placeholder="搜索已经关注的人" style="width:100%;" />
      </div>
    </div>
    <div class="main">
      <div class="name" v-for="(userInfo, index) in userarr" :key="index">
        <van-cell-group
          style="width:100%;height:100%;margin-bottom: .5rem;display:flex;align-items:center;justify-content: space-between;"
        >
          <div class="usermsg">
            <div class="my_pic">
              <img
                src="../../static/icon/图片/头像6.png"
                alt="你的头像"
                style="width: 1.28rem;height: 1.28rem;border-radius: 50%;"
                class="animated rotateIn"
              />
            </div>
            <div class="msg_all">
              <p style="font-size: 0.42rem;font-weight: bold;margin-bottom: .08rem;">
                {{ userInfo.name }}
              </p>
          ...
          <div class="my_icon" @touchstart="icontouch(index)">
            <img
              src="../../static/icon/未点赞1.png"
              alt="图标"
              style="width: 0.7rem;height: 0.7rem;"
              v-if="userInfo.iconshow == false"
            />
            <img
              src="../../static/icon/点赞1.png"
              alt="图标"
              style="width: 0.7rem;height: 0.7rem;"
              v-else
            />
