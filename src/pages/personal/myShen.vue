              ...
              <div class="usermsg">
                <div class="my_pic animated zoomIn">
                  <img
                    ...
                    alt="你的头像"
                    style="width: 0.53rem;height: 0.53rem;border-top-left-radius: 0.1rem;"
                  />
                  <img
                    src="../../static/icon/图片/头像6.png"
                    alt="你的头像"
                    style="width: 0.53rem;height: 0.53rem;border-top-right-radius: 0.1rem;"
                  />
                  <img
                    src="../../static/icon/图片/头像6.png"
                    alt="你的头像"
                    style="width: 0.53rem;height: 0.53rem;border-bottom-left-radius: 0.1rem;"
                  />
                  <img
                    src="../../static/icon/图片/头像6.png"
                    alt="你的头像"
                    style="width: 0.53rem;height: 0.53rem;border-bottom-right-radius: 0.1rem;"
                  />
                </div>
                <div class="msg_all">
                  <p style="font-size: 0.42rem;font-weight: bold;">
                    {{ userInfo.name }}
                  </p>
                  <p style="font-size: 0.32rem;color:#708292;margin-top:0.1rem">
