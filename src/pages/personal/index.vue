  ...
  <div class="content">
    <div class="top animated fadeInDown">
      <div class="top_left">
        <div class="nicheng">
          <p
            style="font-size: 0.3rem;line-height:0.3rem;height:0.52rem;color:rgba(111,129,145,1);"
          >
            每个人都有快乐的时候，你呢？
          </p>
          <p style="font-size: 0.46rem;margin-bottom: 5px;font-weight:bold">
            作者昵称
          </p>
        </div>
        <div class="fenguan">
          <div class="fens" @touchstart="$router.push('/myFans')">
            <p style="font-size: 0.3rem;color:rgba(111,129,145,1);">粉丝</p>
            <p style="font-size: 0.3rem;color:black">135</p>
          </div>
          <div class="guanz" @touchstart="$router.push('/myFollow')">
            <p style="font-size: 0.3rem;color:rgba(111,129,145,1);">关注</p>
            <p style="font-size: 0.3rem;color:black">209</p>
          </div>
        </div>
      </div>
      <div class="top_right">
